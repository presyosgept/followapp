...
urlpatterns = [
    ...
    path('counselor/view_detail/?P:<int:id>/<str:type>', counselor_view_detail_referred_students,
    ...
    path('counselor/counselor_detail_schedule_class/<str:offer_code>/<str:sem_id>/<str:year>',
         counselor_detail_schedule_class, name="counselor_detail_schedule_class"),
...
#     path('student/view_class_students/<str:offer_code>/<str:sem_id>/<str:year>',
#          view_class_students, name="view_class_students"),
