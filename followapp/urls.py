...
urlpatterns = [
    ...
    path('admin/uploadteachers', upload_teachersload, name="upload_teachersload"),
    ...
    path('studentslist/new', new, name='new'), 
    ...
    path('counselor/manual_detail/<str:pk>/<str:created_by>', manual_detail, name="manual_detail"),
